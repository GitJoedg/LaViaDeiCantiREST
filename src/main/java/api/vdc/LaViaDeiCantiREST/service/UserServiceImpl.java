...
public class UserServiceImpl implements UserService{
    ...
    public String saveUser(@RequestBody User user){
        ...
        userRepository.setUserStatus(User.USERSTATUS_OFFLINE, user.getUsername());
        return "{}";
    }
    /**
    ...
    public User validateUser(@RequestBody User user) {
        ...
        if (userDAO.isPresent()) {
            ...
            if(Arrays.equals(hash, userDAO.get().getHash())){
                userRepository.setUserStatus(User.USERSTATUS_ONLINE, username);
                User result = userDAO.get();
                result.setUserStatus(User.USERSTATUS_ONLINE);
                return result;
            }
        }
        return null;
    ...
    public void logoutUser(String username){
        userRepository.setUserStatus(User.USERSTATUS_OFFLINE, username);
    }
}
